...
const addOnPacks = [
  {
    ...
    "questions": [
      ...
      { "id": "cp15", "text": "چالش سوپرایز؛ یک عادت عجیب پارتنرت که اوایل نمی‌دونستی و بعداً فهمیدی چی بوده؟" },
      ...
      { "id": "cp30", "text": "کد اضطراری؛ یک کلمه رمزی انتخاب کنید که وسط بحث یعنی «بیایید آروم‌تر ادامه بدیم»" },
      { "id": "cp31", "text": "جزئیات جذاب؛ کدوم حرکت یا حالت کاملاً معمولی پارتنرت ناگهان برات جذاب می‌شه؟" },
      ...
      { "id": "cp48", "text": "خانه آینده؛ هرکدوم جداگانه سه ویژگی خانه رویایی مشترکتون رو بگید و جواب‌ها رو مقایسه کنید" },
  ...
  },
  {
    ...
    "questions": [
      ...
      { "id": "gi20", "text": "پاکسازی فالو؛ چه مدل اکانتی رو می‌بینی و فوری آنفالو می‌کنی؟" },
      { "id": "gi21", "text": "کد دخترونه؛ یک قانون نانوشته بین دوست‌های دختر که همه باید رعایت کنن چیه؟" },
      { "id": "gi22", "text": "تغییر استایل؛ یکی از افراد جمع برای قرار بعدی‌ات یک تیپ کامل پیشنهاد بده" },
      { "id": "gi23", "text": "پیام تحلیل؛ یک پیام مبهم عاشقانه تعریف کن که برای فهم منظورش جلسه مشورتی گذاشتید" },
      ...
      { "id": "gi29", "text": "هشدار دوستانه؛ تا حالا درباره یک نفر به دوستت هشدار دادی و بعداً ثابت شد حق با تو بوده؟" },
      ...
      { "id": "gi44", "text": "رقابت پنهان؛ تا حالا با دوستی وارد رقابتی شدی که هیچ‌کدومتون به زبون نیاوردید؟" },
  ...
  },
  {
    ...
    "questions": [
      ...
      { "id": "bo30", "text": "ماموریت گروهی؛ برای یک سرقت سینمایی به هر نفر جمع چه نقشی می‌دی؟" },
      ...
      { "id": "bo42", "text": "قرار خراب؛ چه اشتباهی در یک دیت کردی که تا مدت‌ها سوژه رفقات شد؟" },
